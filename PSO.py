# -*- coding: utf-8 -*-
"""
Created on Thu Feb 27 16:03:22 2020
...
def func1(x):
    return lab[np.where(np.unique(label) == label[x[0]][x[1]])]
...
class PSO():
    def __init__(self,x0,bounds,num_particles,maxiter, labels):
        global num_dimensions, label, lab
        lab = np.unique(labels)[-1::-1]
        self.x0 = x0
        self.bounds = bounds
